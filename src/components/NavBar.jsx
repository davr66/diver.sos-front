...
export default function NavBar(){
  ...
  return (
    ...
    rounded-full border-2 border-b-5 border-r-5 pt-1 pb-2 w-[96%] mx-auto
    ">
      ...
      {isLoggedIn ? <NavItem href={'/perfil'} label={'Perfil'} Icon={ProfileIcon} IconActive={ProfileIconFilled} bgColor={'#C5ACFF'}></NavItem> : <NavItem href={'/login'} label={'Login'} Icon={LoginIcon} IconActive={LoginIconFilled} bgColor={'#CCFFB4'} match={["/login","/cadastro","/esqueci-senha","/recuperar-senha"]}></NavItem>}
    </nav>
  )
}