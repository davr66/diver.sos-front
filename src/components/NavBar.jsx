...
export default function NavBar(){
  ...
  return (
    ...
    nth-1:mb-100">
      ...
      {isLoggedIn ? <NavItem href={'/perfil'} label={'Perfil'} Icon={ProfileIcon} IconActive={ProfileIconFilled} bgColor={'#C5ACFF'}></NavItem> : <NavItem href={'/login'} label={'Login'} Icon={LoginIcon} IconActive={LoginIconFilled} bgColor={'#CCFFB4'}></NavItem>}
    </nav>
  )
}